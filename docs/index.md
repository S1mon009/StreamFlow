...
The Video Downloader app provides a command-line interface to:

- Download single videos or entire playlists.
- Download audio only.
- Choose video quality and output format.
- Download multiple links from a `.txt` file.
- Handle network interruptions and resume downloads.
